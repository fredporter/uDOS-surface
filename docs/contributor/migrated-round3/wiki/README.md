# uDosDev wiki (migrated stub)

Short **beginner / how-to** units for the governance repo. Stable specs and process live in **`docs/`** on **[uDosDev](https://github.com/fredporter/uDosDev)**; deep roadmap and rounds live under **`docs/future/`** and **`docs/specs/`** there.
