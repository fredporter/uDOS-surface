...
Upstream **`uDosDocs/tests/`** notes (migrated snapshot). In **uDosConnect**, docs validation is **not** the legacy `scripts/run-docs-checks.sh` from uDosDocs (that script targets the old repo layout; see [`scripts/imported/2026-04-15-uDosDocs/README.md`](../../../../scripts/imported/2026-04-15-uDosDocs/README.md)).
