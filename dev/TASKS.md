...
| **T-ALPHA-UOS** | External app launcher (`uos`) | Scaffold: [`modules/uos/`](../modules/uos/) — `udo app list`, `udo app launch <app> [args…]` (dry-run → `go run ./cmd/uos`); **next:** `--execute` + real `docker`/`podman` |
