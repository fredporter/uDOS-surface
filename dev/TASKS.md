...
| **T-ALPHA-VENTOY**           | Ventoy packaging/installer lane (**external repo**)                    | **Moved out of `uDosConnect` scope.** Ventoy install/packaging modules belong to `sonic-screwdriver` (and family `sonic-ventoy`) repo flow; this repo consumes `sonic-express` only. Keep `distro/ventoy/` as legacy scaffold reference, not an active alpha lane here.                                                                                                                                                                                                                                                                                                                                                                                   |
