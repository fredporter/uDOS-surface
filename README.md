...
| [`modules/`](modules/) | In-tree **product modules** (first: **[`modules/ucoin/`](modules/ucoin/)** — barter-default uCoin spec, courses, phased implementation). Not the same as Git **submodules** (`uDosDev` / `uDosDocs`). |
